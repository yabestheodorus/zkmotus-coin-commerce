...
contract ZKMotusRegistryTest is ZKMotusPaymentTest {
    ...
    function _generateProof(bytes32 _orderCommitment, bytes32 serialNumberHashed, uint256 serialNumber, uint256 nonce)
        public
    ...
    function testVerifyAuthenticityNotFromMerchant() public {
        ...
        bytes32 nonce = keccak256(abi.encodePacked(product1Serial, block.timestamp));
    ...
    function testVerifyAuthenticityWithInvalidProof() public {
        ...
        registry.registerAuthenticity(purchaseCommitmentProduct1, orderCommitment, product1SerialHashed);
        registry.registerAuthenticity(purchaseCommitmentProduct2, orderCommitment, product2SerialHashed);
